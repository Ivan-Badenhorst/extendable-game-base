...
{
    QPixmap penemyIconAlive = QPixmap(":/enemy/PEnemy/PEnemy_alive");
    QPixmap penemyIconDefeated = QPixmap(":/enemy/PEnemy/PEnemy_dead");
...
{
    QPixmap fire1Icon = QPixmap(":/enemy/PEnemy/fire1");
    QPixmap fire2Icon = QPixmap(":/enemy/PEnemy/fire2");
    QPixmap fire3Icon = QPixmap(":/enemy/PEnemy/fire3");
    QPixmap fire4Icon = QPixmap(":/enemy/PEnemy/fire4");
